...
with DAG(
    dag_id=f"greenery_no_partition_data_pipeline",
    ...
    with TaskGroup(group_id="transform_data") as transform_data_group:
        for item in DATA_WITHOUT_PARTITION:
            ...
            transform_data = SparkSubmitOperator(
                ...
                application=f"/opt/spark/pyspark/w04_no_partition_from_gcs_to_bq.py",
                conn_id="my_spark",
                # Send argument to spark
                application_args=[item],
